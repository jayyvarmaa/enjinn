	...
	const void *userParam)
{
	...
	enjinn::OpenglLogsWindow *openglLogsWindow = (enjinn::OpenglLogsWindow*)userParam;
...
void enjinn::OpenglLogsWindow::init(enjinn::enjinnImgui::ImGuiIdsManager &idManager)
{
...
void enjinn::OpenglLogsWindow::update(bool &open)
{
