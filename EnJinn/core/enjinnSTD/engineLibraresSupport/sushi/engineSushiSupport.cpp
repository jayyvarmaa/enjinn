...
namespace enjinn
{
	...
	::sushi::SushiInput toSushi(const enjinn::Input &in)
	{
		...
		static_assert(::sushi::SushiButton::BUTTONS_COUNT == ::enjinn::Button::BUTTONS_COUNT, "");
		for (int i = 0; i < ::sushi::SushiButton::BUTTONS_COUNT; i++)
		{
			out.buttons[i] = toSushi(in.buttons[i]);
		}

		static_assert(sizeof(::sushi::SushiInput::typedInput) == sizeof(::enjinn::Input::typedInput), "");
		memcpy(out.typedInput, in.typedInput, sizeof(::sushi::SushiInput::typedInput));

		out.deltaTime = in.deltaTime;

		static_assert(::sushi::SushiInput::MAX_CONTROLLERS_COUNT == ::enjinn::Input::MAX_CONTROLLERS_COUNT, "");
	...
	::sushi::SushiController toSushi(const enjinn::Controller &in)
	{
		...
		static_assert(::sushi::SushiController::ButtonsCount == ::enjinn::Controller::ButtonsCount, "");
