...
void enjinn::EnJinnWindow::create()
{
    ...
    // Use native Windows chrome (title bar and system buttons)
    glfwWindowHint(GLFW_DECORATED, GLFW_TRUE);

    context.wind = glfwCreateWindow((std::max)(wr.z, 1280), (std::max)(wr.w, 720), "EnJinn", nullptr, nullptr);
    ...
    // Keep dark mode while keeping native decorations
