...
struct AngryBirds: public Container
{
	...
	{
		ENJINN_RESOURCES_PATH "sus/woodballs.png",
		ENJINN_RESOURCES_PATH "sus/woodsmall.png",
		ENJINN_RESOURCES_PATH "sus/stoneplank.png",
		ENJINN_RESOURCES_PATH "sus/glassplank.png",
		ENJINN_RESOURCES_PATH "sus/woodplank.png",
		ENJINN_RESOURCES_PATH "sus/glass.png",
		ENJINN_RESOURCES_PATH "sus/wood.png",
		ENJINN_RESOURCES_PATH "sus/stone.png",
		ENJINN_RESOURCES_PATH "sus/pig.png",
		ENJINN_RESOURCES_PATH "sus/red.png",
	};
	...
	static ContainerStaticInfo containerInfo()
	{
		...
		info.defaultHeapMemorySize = enjinn::MB(40);
	...
	bool create(RequestedContainerInfo &requestedInfo, enjinn::StaticString<256> commandLineArgument)
	{
		...
		for (int i = 0; i < 10; i++)
		{
			textures[i] = enjinn::gl2d::loadTexture(textureNames[i], requestedInfo);
		...
		background = enjinn::gl2d::loadTexture(ENJINN_RESOURCES_PATH "sus/background.png", requestedInfo);
		background.bind();
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
		backgroundSize = background.GetSize();

		sling = enjinn::gl2d::loadTexture(ENJINN_RESOURCES_PATH "sus/sling.png", requestedInfo);
	...
	#pragma endregion
		...
		enjinn::gl2d::cameraController(renderer.currentCamera, input, 500, 3);
