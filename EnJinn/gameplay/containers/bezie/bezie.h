...
struct Bezie : public Container
{
	...
	static ContainerStaticInfo containerInfo()
	{
		...
		info.defaultHeapMemorySize = enjinn::MB(1000);
	...
	bool create(RequestedContainerInfo &requestedInfo, enjinn::StaticString<256> commandLineArgument)
	{
		...
		renderer3D.init(1, 1, ENJINN_RESOURCES_PATH "BRDFintegrationMap.png", requestedInfo.requestedFBO.fbo);

		renderer3D.skyBox = renderer3D.loadSkyBox(ENJINN_RESOURCES_PATH "/skyBoxes/skybox.png");
		
		sphere = renderer3D.loadModel(ENJINN_RESOURCES_PATH "/marioKart/sphere.obj", gl3d::maxQuality, 0.5f);
