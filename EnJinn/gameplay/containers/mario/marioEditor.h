...
struct MarioEditor: public Container
{
	...
	bool create(RequestedContainerInfo &requestedInfo, enjinn::StaticString<256> commandLineArgument)
	{
		...
		tiles = enjinn::gl2d::loadTextureWithPixelPadding(ENJINN_RESOURCES_PATH "/mario/1985_tiles.png", requestedInfo, 8, true, false);
		...
		if (rez)
		{
			enjinn::strlcpy(path, commandLineArgument.data(), commandLineArgument.size()+1);
