...
struct Logo: public Container
{
	...
	static ContainerStaticInfo containerInfo()
	{
		...
		info.defaultHeapMemorySize = enjinn::MB(20);
	...
	bool create(RequestedContainerInfo &requestedInfo, enjinn::StaticString<256> commandLineArgument)
	{
		...
		ballTexture = enjinn::gl2d::loadTexture(ENJINN_RESOURCES_PATH "ball.png", requestedInfo);
		logoTexture = enjinn::gl2d::loadTexture(ENJINN_RESOURCES_PATH "logo2.png", requestedInfo);
		...
		auto file = requestedInfo.readEntireFileBinaryAsAString(ENJINN_RESOURCES_PATH "physicsOrder.txt");
	...
	//renderer.renderCircleOutline(b.center, b.r, color, 2, 32);
		...
		if (ImGui::Button("Make Photo"))
		{
			...
			{
				std::ofstream f(ENJINN_RESOURCES_PATH "physicsOrder.txt");
